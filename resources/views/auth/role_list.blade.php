          ...
          <div class="span12">
            <div class="widget">
              <div class="widget-header">
                <i class="icon-list"></i>
                <h3>Daftar Tipe User</h3>
              </div>

              <div class="widget-content">
                <table class="table table-striped table-bordered" id="role-table" width="100%" >
                    <thead>
                        <tr>
                            <th></th>
                            <th></th>
...
function format ( d ) {
    ...
    var content = '';
    $.each(d.perms, function(key, value) {
      content += '<tr>'+
                  '<td>'+value.name+'</td>'+
...
$(function() {
    var table = $('#role-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ url("api/role_list?api_token=") }}{{ Auth::user()->api_token }}',
        columns: [
    ...
    $('#role-table').on('click', 'td.details-control', function () {
