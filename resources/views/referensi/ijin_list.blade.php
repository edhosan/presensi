...
<div class="main">
  <div class="main-inner">
      <div class="container">
          {!! Breadcrumbs::render('ref_ijin.list') !!}
          <div class="row">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <i class="icon-list"></i>
                  <h3>Daftar Keterangan Tidak Hadir</h3>
                </div>

                <div class="widget-content">
                  <table class="table table-striped table-bordered" id="ref-ijin-table" width="100%" >
                      <thead>
                          <tr>
                              <th></th>
                              <th></th>
...
$(function() {
    ...
    var table = $('#ref-ijin-table').DataTable({
        dom: 'Bfrtip',
        scrollX: true,
        select: {
            style:    'multi',
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ url("api/ref_ijin_list?api_token=") }}{{ Auth::user()->api_token }}',
        columns: [
