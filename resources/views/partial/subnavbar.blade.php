  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        @endrole
        <li class="dropdown {{ active(['home/*','register','kalendar_list','jadwal_list','ref_ijin_list','pengumuman_index','tpp.kategori.index']) }}">
          ...
          <ul class="dropdown-menu">
            ...
            @role(['super-admin'])
              ...
              <li><a href="{{ route('tpp.kategori.index') }}">Standarisasi Biaya TPP</a></li>
        ...
        <li class="dropdown {{ active(['laporan.bulanan','laporan.harian','laporan.ketidakhadiran']) }}">
          ...
          <ul class="dropdown-menu">
            @role(['super-admin','admin','user-report'])
