...
Route::group(['namespace' => 'Referensi', 'middleware' => 'auth'], function() {
  Route::get('/tpp/kategori','MasterTPPController@index')->name('tpp.kategori.index');
  Route::get('/tpp/kategori/create','MasterTPPController@createKategori')->name('tpp.kategori.create');
  ...
  Route::post('/tpp/rincian_pengeluaran/create/save','MasterTPPController@saveRincianPengeluaran')->name('tpp.rincian_pengeluaran.save');
});
